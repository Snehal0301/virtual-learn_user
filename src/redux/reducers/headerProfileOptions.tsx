...
export const { headerProfile, profileDrawer, searchFocus, profileSection, notificationSection, settingsSection, privacySection, termsSection, showChangePasswordSection, editProfileSection } =
